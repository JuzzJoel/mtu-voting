...
const categories = [
  ...
  { title: "Hairstylist of the Year (Male)", order: 20 },
  { title: "Fashion Designer of the Year", order: 21 },
  { title: "Sportsman of the Year", order: 22 },
  { title: "Sportswoman of the Year", order: 23 },
  { title: "Content Creator of the Year", order: 24 },
  { title: "Most Sociable (Male)", order: 25 },
  { title: "Most Sociable (Female)", order: 26 },
  { title: "Videographer of the Year", order: 27 },
